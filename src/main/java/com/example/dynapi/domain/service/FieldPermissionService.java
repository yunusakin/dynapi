...
public interface FieldPermissionService {
    ...
    Map<String, Object> applyFieldMasking(Map<String, Object> data, String entityName, Set<String> userRoles);
    FieldPermission setFieldPermissions(String fieldName, String entityName, Set<String> readRoles, Set<String> writeRoles);
