...
public class FieldPermissionServiceImpl implements FieldPermissionService {
  ...
  @Override
  public Map<String, Object> applyFieldMasking(
  ...
  @Override
  public FieldPermission setFieldPermissions(
  ...
  public void removeFieldPermissions(String fieldName, String entityName) {
    Query query =
        new Query(Criteria.where("fieldName").is(fieldName).and("entityName").is(entityName));
