...
import com.dynapi.application.query.DynamicQueryService;
import com.dynapi.domain.model.DynamicQuery;
import com.dynapi.domain.model.DynamicQuery.QueryFilter;
...
public class MongoDynamicQueryService implements DynamicQueryService {
    ...
    public Page<Map<String, Object>> executeQuery(String entityName, DynamicQuery dynamicQuery) {
        ...
        List<Map<String, Object>> results = (List<Map<String, Object>>) (List<?>) mongoTemplate.find(query, Map.class, entityName);
