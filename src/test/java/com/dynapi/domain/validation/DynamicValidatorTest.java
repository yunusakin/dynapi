...
class DynamicValidatorTest {
  ...
  void validate_acceptsPayload_whenRulesAreSatisfied() {
    ...
    Map<String, Object> data =
        Map.of(
            ...
            92,
            "profile",
            Map.of("age", 24, "email", "dev@dynapi.io"),
            "items",
            List.of(Map.of("name", "task", "qty", 2)));
        ...
        assertThrows(
            ...
            () ->
                dynamicValidator.validate(
                    Map.of("status", "ARCHIVED"), List.of(status), Locale.US));
  ...
  void validate_rejectsRegexViolation_onNestedObject() {
    ...
    Map<String, Object> data = Map.of("profile", Map.of("email", "not-an-email"));
  ...
  void validate_rejectsMinMaxViolation_onStringAndArray() {
    ...
    Map<String, Object> shortTitleData = Map.of("title", "Hi", "tags", List.of("a"));

    ValidationException titleEx =
        assertThrows(
            ValidationException.class,
            () -> dynamicValidator.validate(shortTitleData, List.of(title, tags), Locale.US));
    assertEquals("title", titleEx.getField());

    Map<String, Object> oversizedArrayData =
        Map.of("title", "Good", "tags", List.of("a", "b", "c"));

    ValidationException arrayEx =
        assertThrows(
            ValidationException.class,
  ...
  void validate_rejectsNestedArrayItemViolation_withPrecisePath() {
    ...
    Map<String, Object> data = Map.of("items", List.of(Map.of("qty", 0)));
